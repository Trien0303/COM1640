...
function sendEmail(?string $recipient_email, ?string $reciptient_fullname, string $message, bool $multi_recipient, ?array $multi_recipient_email)
{
  $mail = new PHPMailer(true);
  ...
  try {
    ...
    //Content
    $mail->isHTML(true);               //Set email format to HTML
    $mail->Subject = "Submit article ";   // email subject headings
