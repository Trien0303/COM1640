                            ...
                            <div class="table-responsive">
                                <table class="table tableEdit table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $sql_user_articles = "SELECT * FROM `articles`
                            WHERE authorId = (SELECT userId FROM users WHERE userId = $userId )";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="?page=updateArticleStudent&id=<?= $row['articleId'] ?>"
                                                    class="btn btn-info view-article-btn"><svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <button type="button" class="btn btn-info view-article-btn"
                                                    ...
                                                    data-bs-target="#viewArticleModal"> Show
                                                </button>
                                            </td>
                                        </tr>
                                        <?php
