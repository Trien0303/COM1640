  ...
  if ($result->num_rows > 0) {
    ...
    if (password_verify($currentPassword, $hashedPassword)) {
      ...
      if ($newPassword === $repeatPassword) {
        ...
        echo "<script>alert('newPassword and repeatPassword do not match')</script>";
        echo "<script>window.history.go(-1);</script>";
      }
    } else {
  ...
  <div class="container">
    ...
    <div class="sttngs">
      ...
      <div class="tabordion">
            ...
            <div class="frm">
              <form action="#" method="POST" enctype="multipart/form-data">
                <div class="tr">
                  ...
                  <input class="input" type="text" id="username" value="<?php echo $row['username'] ?>" readonly>
                  <label class="label" for="name">Name</label>
                  <input class="input" type="text" id="name" value="<?php echo $row['name'] ?>">
                  <label class="label" for="address">HOMETOWN</label>
                  <input class="input" type="text" id="address" value="<?php echo $row['address'] ?>">
                ...
                WHERE u.username = '$username'";
                  ...
                  ?>
                  <input class="input" type="text" id="faculty" name="faculty" value="<?php echo $rowFaculties['facultyName'] ?>" readonly>
                  <label class="label" for="textarea">Note <p id="count"></p></label>
                  <textarea class="textarea e" rows="6" cols="25" id="aboutYou" name="aboutYou" maxlength="500"><?php echo $row['aboutYou'] ?></textarea>
                </div>
        ...
        <section id="section2" style="position: static;">
          ...
          <article>
            <form action="#" method="POST" enctype="multipart/form-data">
              <div class="tr wwq">
                ...
                <label class="label" for="input">comfirm password</label>
        ...
        <section id="section3" style="position: static;"><a href="#" onclick="confirmLogout()" style="text-decoration: none;">
